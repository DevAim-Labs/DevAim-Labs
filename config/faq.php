...
return [
    ...
    [
        ...
        'a' => 'Dat hangt af van de scope. Een gerichte landingspagina of admin-MVP kan enkele weken duren; grotere dashboards met integraties lopen vaak enkele maanden.',
    ],
    [
