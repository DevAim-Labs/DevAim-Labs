<footer class="mt-8" style="background: var(--color-surface)">
    <div class="max-w-6xl mx-auto px-6 py-12 flex flex-col md:flex-row justify-between items-start gap-8">
        <div>
            ...
            <p class="text-sm text-[var(--color-text-muted)] mt-1 max-w-xs">Full-stack web development for ambitious projects.</p>
        </div>
        <nav class="flex gap-6 text-sm text-[var(--color-text-muted)]">
            <a href="#services" class="hover:text-[var(--color-text)] transition-colors duration-200">Services</a>
            <a href="#portfolio" class="hover:text-[var(--color-text)] transition-colors duration-200">Work</a>
